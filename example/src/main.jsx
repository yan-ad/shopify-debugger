  ...
  return (
    <main className="page">
      <section className="hero">
        <p className="eyebrow">shopify-debugger</p>
        ...
        <p>
          ...
          <code>SHOPIFY_DEBUGGER=true</code>, open <code>/_debugger</code>, and
          the Vite plugin will alias App Bridge to the local debugger shim.
        </p>
      </section>
