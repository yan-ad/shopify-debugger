...
<body>
  <header>
    ...
    <form class="actions" id="debugger-form">
      <s-input-text id="debugger-url" value="${escapedAppUrl}" aria-label="App URL" />
      <s-button type="submit" variant="primary">Load</s-button>
      <s-button type="button" id="debugger-refresh" variant="secondary">Refresh</s-button>
    </form>
  </header>
  <main>
